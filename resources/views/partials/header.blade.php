<header class="header">
    ...
    <section class="ps-header--center header-desktop">
        <div class="container">
            <div class="header-inner">
                <div class="header-inner__left"><a class="logo" href="index.html">Aquila<span class="text-color-2">Impex.</span></a>
                    <ul class="menu">
                ...
                <li class="menu-item-has-children has-mega-menu menu-item-branch"><a class="nav-link" href="javascript:void(0);">Brand</a>
                    <div class="mega-menu mega-brand">
                        ...
                        <div class="brand-box">
                            ...
                            <div class="row">
                                <div class="col-4"><a href="shop-view-grid.html"><img src="/assets/img/brand/brand_themeforest.jpg" alt="alt" /></a></div>
                                <div class="col-4"><a href="shop-view-grid.html"><img src="/assets/img/brand/brand_envato.jpg" alt="alt" /></a></div>
                                <div class="col-4"><a href="shop-view-grid.html"><img src="/assets/img/brand/brand_codecanyon.jpg" alt="alt" /></a></div>
                                <div class="col-4"><a href="shop-view-grid.html"><img src="/assets/img/brand/brand_cudicjungle.jpg" alt="alt" /></a></div>
                                <div class="col-4"><a href="shop-view-grid.html"><img src="/assets/img/brand/brand_videohive.jpg" alt="alt" /></a></div>
                                <div class="col-4"><a href="shop-view-grid.html"><img src="/assets/img/brand/brand_photodune.jpg" alt="alt" /></a></div>
                                <div class="col-4"><a href="shop-view-grid.html"><img src="/assets/img/brand/brand_evatotuts.jpg" alt="alt" /></a></div>
                                <div class="col-4"><a href="shop-view-grid.html"><img src="/assets/img/brand/brand_3docean.jpg" alt="alt" /></a></div>
                                <div class="col-4"><a href="shop-view-grid.html"><img src="/assets/img/brand/microlancer.jpg" alt="alt" /></a></div>
