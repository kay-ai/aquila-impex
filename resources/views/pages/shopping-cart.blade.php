@extends('layouts.app', [$activePage = 'Cart'])
                    ...
                    <div class="row m-0">
                        <div class="col-12 col-lg-8">
                            <div class="shopping-cart__products">
                                            ...
                                            <div class="cart-product">
                                                <div class="ps-product--mini-cart"><a href="{{route('product-view')}}"><img class="ps-product__thumbnail" src="/assets/img/products/01-Fresh/01_18a.jpg" alt="alt" /></a>
                                                    <div class="ps-product__content">
                                                        ...
                                                        <p class="ps-product__soldby">Sold by <span>AquilaImpex</span></p>
                                ...
                                <div class="shopping-cart__step"><a class="clear-item" href="javascript:void(0);">Clear all items</a><a class="button right" href="javascript:void(0);"><i class="icon-sync"> </i>Update Cart</a><a class="button left" href="{{route('shop')}}"><i class="icon-arrow-left"></i>Continue Shopping</a></div>
                                <div class="row">
