@extends('layouts.app', [$activePage = 'Checkout'])
                        ...
                        <div class="col-12 col-lg-5">
                            ...
                            <div class="checkout__payment">
                                ...
                                <div class="form-group--block">
                                    ...
                                    <label class="label-checkbox" for="checkboxPaypal"><b class="text-heading">PayPal </b><img src="/assets/img/promotion/payment_visa.jpg" alt><img src="/assets/img/promotion/payment_mastercart.jpg" alt><img src="/assets/img/promotion/payment_electron.jpg" alt><a>What is PayPal?</a></label>
                                </div>
                            </div>
