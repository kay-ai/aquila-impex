@extends('layouts.app', [$activePage = 'Products'])
...
@section('main')
    <main class="no-main">
        ...
        <section class="section--product-type section-product--default">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-lg-6">
                                        ...
                                        <div class="ps-product__shopping">
                                            ...
                                            </div><a class="ps-product__addcart ps-button" data-toggle="modal" data-target="#popupAddToCart"><i class="icon-cart"></i>Add to cart</a><a class="ps-product__icon" href="wishlist.html"><i class="icon-heart"></i></a><a class="ps-product__icon"><i class="icon-repeat"></i></a>
                                        </div>
                                        ...
                                        <div class="ps-product__footer"><a class="ps-product__shop" href="{{route('shop')}}"><i class="icon-store"></i><span>Store</span></a><a class="ps-product__addcart ps-button" data-toggle="modal" data-target="#popupAddToCart"><i class="icon-cart"></i>Add to cart</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="ps-product--combo">
                <div class="container">
                    <h3>Frequently Bought Together</h3>
                    <div class="combo__content">
                        <div class="row">
                            <div class="col-6 col-md-4 col-lg-2dot4 combo__item">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="checkbox0" value="" checked="checked" disabled>
                                    <label for="checkbox0"></label>
                                </div>
                            </div>
                            <div class="col-6 col-md-4 col-lg-2dot4 combo__item">
                                <div class="ps-product--standard"><a href="{{route('product-view')}}"><img class="ps-product__thumbnail" src="/assets/img/products/07-Beer-WineSpirits/07_8a.jpg" alt="alt" /></a>
                                    <div class="ps-product__content">
                                        <p class="ps-product__type"><i class="icon-store"></i>AquilaImpex</p>
                                        ...
                                        <p class="ps-product-price-block"><span class="ps-product__sale">$69.99</span><span class="ps-product__price">$72.00</span><span class="ps-product__off">45% Off</span>
                                        </p>
                                    </div>
                                </div>
                                <div class="form-check">
                            ...
                            <div class="col-6 col-md-4 col-lg-2dot4 combo__item">
                                <div class="ps-product--standard"><a href="{{route('product-view')}}"><img class="ps-product__thumbnail" src="/assets/img/products/01-Fresh/01_12a.jpg" alt="alt" /></a>
                                    <div class="ps-product__content">
                                        <p class="ps-product__type"><i class="icon-store"></i>John Farm</p>
                                        <h5><a class="ps-product__name" href="#">Natures Own 100% Wheat</a></h5>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="checkbox2" value="" checked="checked">
                            ...
                            <div class="col-6 col-md-4 col-lg-2dot4 combo__item">
                                <div class="ps-product--standard"><a href="{{route('product-view')}}"><img class="ps-product__thumbnail" src="/assets/img/products/01-Fresh/01_16a.jpg" alt="alt" /></a>
                                    <div class="ps-product__content">
                                        ...
                                        <h5><a class="ps-product__name" href="#">Avocado, Hass Large</a></h5>
                                        <p class="ps-product__unit">100g</p>
                                        <div class="ps-product__rating">
                                            <select class="rating-stars">
                                                <option value="1">1</option>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="checkbox3" value="" checked="checked">
                                    <label for="checkbox3"></label>
                                </div>
                            </div>
                            <div class="col-12 col-md-4 col-lg-2dot4">
                                <div class="combo__total">
                                    <p>Price for all:</p>
                                    <p><span class="combo__sale">$34.99</span><span class="combo__price">$39.90</span></p>
                                    <button class="btn ps-button combo__button"><i class="icon-cart"></i>Add all to cart</button>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="product__related pt-5">
                    <h3 class="product__name">Customers Also Buy These Products</h3>
                    <div class="owl-carousel" data-owl-auto="true" data-owl-loop="true" data-owl-speed="5000" data-owl-gap="0" data-owl-nav="true" data-owl-dots="true" data-owl-item="5" data-owl-item-xs="2" data-owl-item-sm="2" data-owl-item-md="3" data-owl-item-lg="5" data-owl-item-xl="5" data-owl-duration="1000" data-owl-mousedrag="on">
                        ...
                        <div class="ps-post--product">
                            <div class="ps-product--standard"><a href="{{route('product-view')}}"><img class="ps-product__thumbnail" src="/assets/img/products/02-FoodCupboard/02_1a.jpg" alt="alt" /></a><a class="ps-product__expand" href="javascript:void(0);" data-toggle="modal" data-target="#popupQuickview"><i class="icon-expand"></i></a><span class="ps-badge ps-product__new">New </span>
                                <div class="ps-product__content">
                                    ...
                                    <p class="ps-product-price-block"><span class="ps-product__sale">$44.99</span><span class="ps-product__price">$48.99</span><span class="ps-product__off">50% Off</span>
                                    </p>
                                </div>
                                <div class="ps-product__footer">
                                    <div class="def-number-input number-input safari_only">
                        ...
                        <div class="ps-post--product">
                            <div class="ps-product--standard"><a href="{{route('product-view')}}"><img class="ps-product__thumbnail" src="/assets/img/products/01-Fresh/01_16a.jpg" alt="alt" /></a><a class="ps-product__expand" href="javascript:void(0);" data-toggle="modal" data-target="#popupQuickview"><i class="icon-expand"></i></a>
                                <div class="ps-product__content">
                                    <p class="ps-product__type"><i class="icon-store"></i>Shannan Yu</p>
                                    <h5><a class="ps-product__name" href="{{route('product-view')}}">Avocado, Hass Large</a></h5>
                                    <p class="ps-product__unit">100g</p>
                                    <div class="ps-product__rating">
                                        <select class="rating-stars">
                                            <option value="1">1</option>
                        ...
                        <div class="ps-post--product">
                            <div class="ps-product--standard"><a href="{{route('product-view')}}"><img class="ps-product__thumbnail" src="/assets/img/products/05-ReadyMeals/05_8a.jpg" alt="alt" /></a><a class="ps-product__expand" href="javascript:void(0);" data-toggle="modal" data-target="#popupQuickview"><i class="icon-expand"></i></a>
                                <div class="ps-product__content">
                                    <p class="ps-product__type"><i class="icon-store"></i>Shannan Yu</p>
                                    ...
                                    <p class="ps-product-price-block"><span class="ps-product__sale">$15.90</span><span class="ps-product__price">$20.00</span><span class="ps-product__off">46% Off</span>
                                    </p>
                                </div>
                                <div class="ps-product__footer">
                                    <div class="def-number-input number-input safari_only">
                        ...
                        <div class="ps-post--product">
                            <div class="ps-product--standard"><a href="{{route('product-view')}}"><img class="ps-product__thumbnail" src="/assets/img/products/01-Fresh/01_6a.jpg" alt="alt" /></a><a class="ps-product__expand" href="javascript:void(0);" data-toggle="modal" data-target="#popupQuickview"><i class="icon-expand"></i></a><span class="ps-badge ps-product__offbadge">25% Off </span>
                                <div class="ps-product__content">
                                    <p class="ps-product__type"><i class="icon-store"></i>Shannan Yu</p>
                                    <h5><a class="ps-product__name" href="{{route('product-view')}}">Honest Organic Still Lemonade</a></h5>
                                    <p class="ps-product__unit">100g</p>
                        ...
                        <div class="ps-post--product">
                            <div class="ps-product--standard"><a href="{{route('product-view')}}"><img class="ps-product__thumbnail" src="/assets/img/products/01-Fresh/01_18a.jpg" alt="alt" /></a><a class="ps-product__expand" href="javascript:void(0);" data-toggle="modal" data-target="#popupQuickview"><i class="icon-expand"></i></a>
                                <div class="ps-product__content">
                                    <p class="ps-product__type"><i class="icon-store"></i>Shannan Yu</p>
                ...
                <div class="product__content">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="description-content" role="tabpanel" aria-labelledby="description-tab">
                            ...
                            <p class="block-content">As one of AquilaImpex's premium beef suppliers, <b class='text-black'>Local Angus</b> works with a coalition of small family farms throughout the Mid-Atlantic region *who feed theri cattle a diet of primarily grass, supplemented by grain throughout the finishing months. Every farm in this program is independently audited for animal welfare practices to ensure the best standards of care.</p><img class="mb-3" src="/assets/img/products/product-default-content.jpg" alt>
                            <p class="text-center pb-4"><i>Every farm in this program is independently audited for animal.</i></p>
                                    ...
                                    <ul class="comment__list">
                                        <li class="comment__item">
                                            ...
                                            <div class="item__content">
                                                ...
                                                <p class="item__des">AquilaImpex is great. AquilaImpex is the most valuable business resource we have EVER purchased. I have gotten at least 50 times the value from AquilaImpex. I just can't get enough of AquilaImpex. I want to get a T-Shirt with AquilaImpex on it so I can show it off to everyone.</p>
                                            </div>
                                        </li>
                                        <li class="comment__item">
                ...
                <div class="recomment__block">
                    <h3 class="product__name">Recommended Recipes</h3>
                ...
                <div class="product__related">
                    ...
                    <div class="owl-carousel" data-owl-auto="true" data-owl-loop="true" data-owl-speed="5000" data-owl-gap="0" data-owl-nav="true" data-owl-dots="true" data-owl-item="5" data-owl-item-xs="2" data-owl-item-sm="2" data-owl-item-md="3" data-owl-item-lg="5" data-owl-item-xl="5" data-owl-duration="1000" data-owl-mousedrag="on">
                        <div class="ps-post--product">
                            <div class="ps-product--standard"><a href="{{route('product-view')}}"><img class="ps-product__thumbnail" src="/assets/img/products/01-Fresh/01_29a.jpg" alt="alt" /></a><a class="ps-product__expand" href="javascript:void(0);" data-toggle="modal" data-target="#popupQuickview"><i class="icon-expand"></i></a>
                                <div class="ps-product__content">
                                    <p class="ps-product__type"><i class="icon-store"></i>AquilaImpex</p>
                        ...
                        <div class="ps-post--product">
                            <div class="ps-product--standard"><a href="{{route('product-view')}}"><img class="ps-product__thumbnail" src="/assets/img/products/01-Fresh/01_30a.jpg" alt="alt" /></a><a class="ps-product__expand" href="javascript:void(0);" data-toggle="modal" data-target="#popupQuickview"><i class="icon-expand"></i></a>
                                <div class="ps-product__content">
                                    <p class="ps-product__type"><i class="icon-store"></i>AquilaImpex</p>
                        ...
                        <div class="ps-post--product">
                            <div class="ps-product--standard"><a href="{{route('product-view')}}"><img class="ps-product__thumbnail" src="/assets/img/products/01-Fresh/01_1a.jpg" alt="alt" /></a><a class="ps-product__expand" href="javascript:void(0);" data-toggle="modal" data-target="#popupQuickview"><i class="icon-expand"></i></a><span class="ps-badge ps-product__new">New </span>
                                <div class="ps-product__content">
                                    <p class="ps-product__type"><i class="icon-store"></i>AquilaImpex</p>
                                    <h5><a class="ps-product__name" href="{{route('product-view')}}">Morrisons The Best Beef Topside</a></h5>
                                    <p class="ps-product__unit">454g</p>
                                    <div class="ps-product__rating">
                                        <select class="rating-stars">
                                            <option value="1">1</option>
